<?php
/**
 * Template Name: Page Compañía - Cultura de Seguridad
 *
 */
?>
...
<div class="">
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-sm-8 text-center">
				...
				<h1 class="pb-5 main-title">Dedicación genuina al bienestar de los equipos y a la creación de un entorno de trabajo seguro</h1>
			</div>
		</div>
	</div>
	</section>
	...
	<!-- //section 2-->
	<!-- section 3 -->
	<section id="section-3 bg-gray" style="background:#f1f1f1">
		<div class="container py-5 ">
			<div class="row py-5">

				<div class="col-lg-6 col-12">
					<img class="img-zoom card-img-top object-fit-fill w-100 rounded"src="http://dosa.saotech.es/wp-content/uploads/2024/10/cultura-de-seguridad.jpg" />
				</div>
	...
	<section id="section-4">
		<div class="container py-5 ">			
				...
				<div class="col-lg-6 col-12 position-relative d-flex align-items-center">
					...
					<div class="ps-5">
						...
						<div class="d-flex gap-2 justify-content-center align-items-center flex-nowrap">
							...
							<img width="30" class="arrow" src="<?php echo get_template_directory_uri(); ?>/assets/img/arrow-right.svg" alt="">
							</a>
						</div>	
						</p>
					</div>
			...
			<div class="col-lg-6 col-12">
				<img class="img-zoom card-img-top object-fit-fill w-100 rounded"src="http://dosa.saotech.es/wp-content/uploads/2024/10/cultura-de-seguridad-grupo.jpg" />
			</div>	
		</div>			
	</div>
	</section>
