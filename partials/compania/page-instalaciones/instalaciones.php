    ...
    <div class="container py-5 over-lines">
        <div class="row pt-5 pb-3">
            ...
            <div class="col-lg-6 col-12 position-relative">
                <div class="pt-3">
                    <p class="big-text">Dragados Offshore opera a nivel mundial desde seis ubicaciones clave: dos patios en Cádiz (España), dos en Tampico y Altamira (México), una base logística en Ciudad del Carmen (México) y oficinas en Ciudad de México y Houston (EE. UU.)
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-12 position-relative">
                <div class="pt-3">
                    <p class="big-text">Sus instalaciones, diseñadas para albergar proyectos complejos offshore, permiten la construcción durante todo el año gracias a su ubicación geográfica y condiciones climáticas favorables.</p>
                </div>
            </div>
        </div>

        <div class="py-5 instalaciones-cards container-instalaciones">
            <?php
            $cards = [
                [
            ...
            foreach ($cards as $card) { 
                ...
                <div class="card-container">
                    <div class="card-container-exp">
                        ...
                        <div class="instalaciones-col-block-wrap">
                            <div class="card-img-top">
                                <img  src="<?php echo get_template_directory_uri(); ?>/assets/img/<?php echo $card['image']; ?>" alt="">
                            </div>
                            <div class="card-text">
                                <h5 class="title"><?php echo $card['title']; ?></h5>
                                <p class="text"><?php echo $card['text']; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
